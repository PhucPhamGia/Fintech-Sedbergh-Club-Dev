...
class C_Database extends BaseController
{
    ...
    public function Binance_Import()
    {
        ...
        return redirect()->to('/database/1/12h/100')->with('success', 'Historical data imported successfully!');
    }
    ...
    public function Binance_Daily_Import()
    {
        ...
        return redirect()->to('database/1/12h/100')->with('success', 'Daily data imported successfully!');
    }
    ...
    public function MA20()
    {
        ...
        return redirect()->to('database/1/12h/100')->with('success', 'MA20 calculated successfully!');
    }
    ...
    public function MA50()
    {
        ...
        return redirect()->to('database/1/12h/100')->with('success', 'MA50 calculated successfully!');
    }
